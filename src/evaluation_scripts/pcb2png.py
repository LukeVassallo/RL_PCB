...
def command_line_args():
  ...
  followed by the path to the .pcb file to be converted to a PNG image. Example:

  args, settings = command_line_args()
  pcb_file = settings["pcb"]
  """

  parser = argparse.ArgumentParser(description='Python script for generating a \
          .png image from a .pcb file.', usage='python pcb2png.py -p \
          <pcb_file>')
